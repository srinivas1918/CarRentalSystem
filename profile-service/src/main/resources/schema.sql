CREATE SCHEMA IF NOT EXISTS crs_profile_schema;
CREATE TABLE IF NOT EXISTS `crs_profile_schema`.`CRS_CUSTOMER` (
...
ADD COLUMN `CUSTOMER_EMAIL` VARCHAR(45) NULL AFTER `CUSTOMER_PHONE`;
 ...
 CREATE TABLE IF NOT EXISTS `crs_profile_schema`.`CRS_VENDOR` (
...
ADD COLUMN `VENDOR_EMAIL` VARCHAR(45) NULL AFTER `VENDOR_PHONE`;
 ...
 CREATE TABLE IF NOT EXISTS `crs_profile_schema`.`CRS_CITIES` (
  `CITY_ID` INT NOT NULL AUTO_INCREMENT,
  `CITY_NAME` VARCHAR(45) NULL,
  `CITY_CREATED_ON` DATETIME NULL,
  PRIMARY KEY (`CITY_ID`));

 CREATE TABLE IF NOT EXISTS `crs_profile_schema`.`CRS_LOCATONS` (
...
CREATE TABLE IF NOT EXISTS `crs_profile_schema`.`CRS_CARS` (
